...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      render={render}
      // A `render` override (e.g. rendering as a Link/anchor) is usually not
      // a native <button>, so default nativeButton to false whenever one is
      // provided — callers can still pass nativeButton explicitly to opt out.
