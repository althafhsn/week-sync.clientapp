...
/**
 * Pages call this to push their title/description/actions up into the
 * persistent shell header, instead of rendering their own header markup.
 */
export function usePageHeader(value: PageHeaderValue) {
  ...
  const { title, description, actions } = value;
